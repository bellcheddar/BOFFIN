...
- [ ] **Phase 5 (rest): classifier and homolog search.** Pfam classification over the pooled embedding, SIFTS mapping to PDB author numbers, and the embedding index for homolog search
