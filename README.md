...
- [ ] **Phase 9 (rest): the 3D overlay.** Dashed lines in the viewer, toggleable by type. A first attempt was written and deleted rather than committed: it built a list of shapes and did nothing with them, and a command that appears to work and draws nothing is worse than not having it
