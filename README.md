...
- [ ] **Phase 7 (rest): assemblies and memory.** Biological assemblies, symmetry mates, altlocs and NMR ensembles in the UI; releasing the web view under memory pressure and restoring from scene state rather than being terminated
