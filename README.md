...
- [ ] **Phase 7 (rest): fetching, assemblies and selection.** RCSB and AlphaFold fetch, BinaryCIF preferred; assemblies, symmetry mates and altlocs; tap-to-select with a persistent inspector; and releasing the web view under memory pressure rather than being terminated
