...
- [ ] **Phase 9 (rest): overlay, diagram and table.** 3D dashed-line overlay toggleable by type, a native 2D interaction diagram exportable as PDF, and a sortable table with CSV export
