...
- [ ] **Phase 8 (rest): builder, scenes and `.pml`.** Visual selection builder for touch, scene decks with presentation mode and external display, Pencil annotation, and `.pml` round-tripping to desktop PyMOL
