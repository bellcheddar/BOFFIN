...
- [ ] **Phase 8 (rest): builder, measurement, scenes and `.pml`.** Visual selection builder for touch, distances and angles, scene decks with presentation mode and external display, Pencil annotation, and `.pml` round-tripping to desktop PyMOL
